 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Benjamin Newcomer");
		  toPrint += p1.toString("bnewcomer6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("David Benas");
		  toPrint += p2.toString("dbenas3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Inseok Hwang");
		  toPrint += p3.toString("ihwang36");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Matthew Berman");
                  toPrint += p4.toString("mberman3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Casey Evanish");
                  toPrint += p5.toString("cevanish3");
